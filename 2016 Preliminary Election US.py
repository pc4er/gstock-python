...
# 2016.02.01-2008.04.01:

import datetime
us['Date']=pd.to_datetime(us['Date']) # Convert type from object to float

priordate = us['Date'][(us.Date > '2016-02-01') & (us.Date <= '2016-03-01')]
priorstock = us['Stock'][(us.Date > '2016-02-01') & (us.Date <= '2016-03-01')]
priorclose = us['Close'][(us.Date > '2016-02-01') & (us.Date <= '2016-03-01')]
...
postdate = us['Date'][(us.Date > '2016-03-01') & (us.Date <= '2016-04-01')]
poststock = us['Stock'][(us.Date > '2016-03-01') & (us.Date <= '2016-04-01')]
postclose = us['Close'][(us.Date > '2016-03-01') & (us.Date <= '2016-04-01')]
...
febcpi = float(CPI.VALUE[CPI.MONTH == '2016/2/1'])
marcpi = float(CPI.VALUE[CPI.MONTH == '2016/3/1'])
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',c='r',title='2016 "Super Tuesday" (2016.03.01) Effect on US Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',color='r',title='2016 "Super Tuesday" (2016.03.01) Effect on US Market')
