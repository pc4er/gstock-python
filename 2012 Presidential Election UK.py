...
priordate = uk['Date'][(uk.Date > '2012-10-06') & (uk.Date <= '2012-11-06')]
priorstock = uk['Stock'][(uk.Date > '2012-10-06') & (uk.Date <= '2012-11-06')]
priorclose = uk['Close'][(uk.Date > '2012-10-06') & (uk.Date <= '2012-11-06')]
...
postdate = uk['Date'][(uk.Date > '2012-11-06') & (uk.Date <= '2012-12-06')]
poststock = uk['Stock'][(uk.Date > '2012-11-06') & (uk.Date <= '2012-12-06')]
postclose = uk['Close'][(uk.Date > '2012-11-06') & (uk.Date <= '2012-12-06')]
...
octcpi = float(CPI.cpi[CPI.Month == '2012 OCT'])
novcpi = float(CPI.cpi[CPI.Month == '2012 NOV'])
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',title='2012 Presidential Election (2012.11.06) Effect on UK Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',title='2012 Presidential Election (2012.11.06) Effect on UK Market')
