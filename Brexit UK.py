...
priordate = uk['Date'][(uk.Date > '2016-05-23') & (uk.Date <= '2016-06-23')]
priorstock = uk['Stock'][(uk.Date > '2016-05-23') & (uk.Date <= '2016-06-23')]
priorclose = uk['Close'][(uk.Date > '2016-05-23') & (uk.Date <= '2016-06-23')]
...
postdate = uk['Date'][(uk.Date > '2016-06-23') & (uk.Date <= '2016-07-23')]
poststock = uk['Stock'][(uk.Date > '2016-06-23') & (uk.Date <= '2016-07-23')]
postclose = uk['Close'][(uk.Date > '2016-06-23') & (uk.Date <= '2016-07-23')]
...
juncpi = float(CPI.cpi[CPI.Month == '2016 JUN'])
julcpi = float(CPI.cpi[CPI.Month == '2016 JUL'])
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',title='Brexit (2016.06.23) Effect on UK Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',title='Brexit (2016.06.23) Effect on UK Market')
