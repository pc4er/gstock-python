...
@author: TroyRuan
"""
## Scottish Independence: 2014.09.18
...
priordate = us['Date'][(us.Date > '2014-08-18') & (us.Date <= '2014-09-18')]
priorstock = us['Stock'][(us.Date > '2014-08-18') & (us.Date <= '2014-09-18')]
priorclose = us['Close'][(us.Date > '2014-08-18') & (us.Date <= '2014-09-18')]
...
postdate = us['Date'][(us.Date > '2014-09-18') & (us.Date <= '2014-10-18')]
poststock = us['Stock'][(us.Date > '2014-09-18') & (us.Date <= '2014-10-18')]
postclose = us['Close'][(us.Date > '2014-09-18') & (us.Date <= '2014-10-18')]
...
sepcpi = float(CPI.VALUE[CPI.MONTH == '2014/9/1'])
octcpi = float(CPI.VALUE[CPI.MONTH == '2014/10/1'])
inf = (octcpi - sepcpi)/sepcpi
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',c='r',title='Scottish Independence (2014.09.18) Effect on US Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',color='r',title='Scottish Independence (2014.09.18) Effect on US Market')
