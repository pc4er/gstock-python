...
@author: TroyRuan
"""
## 2012 Presidential Election: 2012.11.06
...
# 2012 Presidential Election: 2012.10.06-2012.12.06:

import datetime
us['Date']=pd.to_datetime(us['Date']) # Convert type from object to float

priordate = us['Date'][(us.Date > '2012-10-06') & (us.Date <= '2012-11-06')]
priorstock = us['Stock'][(us.Date > '2012-10-06') & (us.Date <= '2012-11-06')]
priorclose = us['Close'][(us.Date > '2012-10-06') & (us.Date <= '2012-11-06')]
...
postdate = us['Date'][(us.Date > '2012-11-06') & (us.Date <= '2012-12-06')]
poststock = us['Stock'][(us.Date > '2012-11-06') & (us.Date <= '2012-12-06')]
postclose = us['Close'][(us.Date > '2012-11-06') & (us.Date <= '2012-12-06')]
...
octcpi = float(CPI.VALUE[CPI.MONTH == '2012/10/1'])
novcpi = float(CPI.VALUE[CPI.MONTH == '2012/11/1'])
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',c='r',title='2012 Presidential Election (2008.11.04) Effect on US Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',color='r',title='2012 Presidential Election (2008.11.04) Effect on US Market')
