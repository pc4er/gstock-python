...
# 2016.05.23-2016.07.23:

import datetime
us['Date']=pd.to_datetime(us['Date']) # Convert type from object to float

priordate = us['Date'][(us.Date > '2016-05-23') & (us.Date <= '2016-06-23')]
priorstock = us['Stock'][(us.Date > '2016-05-23') & (us.Date <= '2016-06-23')]
priorclose = us['Close'][(us.Date > '2016-05-23') & (us.Date <= '2016-06-23')]
...
postdate = us['Date'][(us.Date > '2016-06-23') & (us.Date <= '2016-07-23')]
poststock = us['Stock'][(us.Date > '2016-06-23') & (us.Date <= '2016-07-23')]
postclose = us['Close'][(us.Date > '2016-06-23') & (us.Date <= '2016-07-23')]
...
juncpi = float(CPI.VALUE[CPI.MONTH == '2016/6/1'])
julcpi = float(CPI.VALUE[CPI.MONTH == '2016/7/1'])
inf = (julcpi - juncpi)/juncpi
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',c='r',title='Brexit (2016.06.23) Effect on US Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',color='r',title='Brexit (2016.06.23) Effect on US Market')
