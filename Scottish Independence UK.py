...
priordate = uk['Date'][(uk.Date > '2014-08-18') & (uk.Date <= '2014-09-18')]
priorstock = uk['Stock'][(uk.Date > '2014-08-18') & (uk.Date <= '2014-09-18')]
priorclose = uk['Close'][(uk.Date > '2014-08-18') & (uk.Date <= '2014-09-18')]
...
postdate = uk['Date'][(uk.Date > '2014-09-18') & (uk.Date <= '2014-10-18')]
poststock = uk['Stock'][(uk.Date > '2014-09-18') & (uk.Date <= '2014-10-18')]
postclose = uk['Close'][(uk.Date > '2014-09-18') & (uk.Date <= '2014-10-18')]
...
sepcpi = float(CPI.cpi[CPI.Month == '2014 SEP'])
octcpi = float(CPI.cpi[CPI.Month == '2014 OCT'])
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',title='Scottish Independence (2014.09.18) Effect on UK Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',title='Scottish Independence (2014.09.18) Effect on UK Market')
