...
priordate = uk['Date'][(uk.Date > '2010-04-02') & (uk.Date <= '2010-05-02')]
priorstock = uk['Stock'][(uk.Date > '2010-04-02') & (uk.Date <= '2010-05-02')]
priorclose = uk['Close'][(uk.Date > '2010-04-02') & (uk.Date <= '2010-05-02')]
...
postdate = uk['Date'][(uk.Date > '2010-05-02') & (uk.Date <= '2010-06-02')]
poststock = uk['Stock'][(uk.Date > '2010-05-02') & (uk.Date <= '2010-06-02')]
postclose = uk['Close'][(uk.Date > '2010-05-02') & (uk.Date <= '2010-06-02')]
...
aprcpi = float(CPI.cpi[CPI.Month == '2010 APR'])
maycpi = float(CPI.cpi[CPI.Month == '2010 MAY'])
...
plotdata = pd.DataFrame({'Stock':plotx,
                         'Diff':stockdiff})
plotdata.plot.scatter(x='Stock',y='Diff',title='Greek Bailout (2010.05.02) Effect on UK Market') 
...
volumedata = pd.DataFrame({'Date':voldate,
                           'TotalVolume':vol})
volumedata.plot.bar(x='Date', y = 'TotalVolume',title='Greek Bailout (2010.05.02) Effect on UK Market')
